...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Location = System::Drawing::Point(209, 153);
			...
			this->label4->Location = System::Drawing::Point(250, 153);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(143, 82);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(56, 16);
			this->label5->TabIndex = 12;
			this->label5->Text = L"Value: 4";
			// 
			// label6
			// 
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(34, 110);
			...
			// trackBar2
			// 
			this->trackBar2->Location = System::Drawing::Point(12, 81);
			this->trackBar2->Maximum = 100;
			this->trackBar2->Name = L"trackBar2";
			this->trackBar2->Size = System::Drawing::Size(125, 45);
			...
			this->ClientSize = System::Drawing::Size(289, 175);
...
{
	int yvalue = trackBar2->Value;
	aimyy = yvalue;
	
	label5->Text = "Value: " + trackBar2->Value.ToString();
}
};
}
